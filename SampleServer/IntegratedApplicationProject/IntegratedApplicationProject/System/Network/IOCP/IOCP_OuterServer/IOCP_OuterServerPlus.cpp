...
unsigned int WINAPI IOCP_OuterServer::AcceptClient(LPVOID selfInstanceAddress)
{
	IOCP_OuterServer* thisInstanceAddress;

	thisInstanceAddress = (IOCP_OuterServer*)selfInstanceAddress;
...
unsigned int WINAPI IOCP_OuterServer::DisconnectClient(LPVOID selfInstanceAddress)
{
	IOCP_OuterServer* thisInstanceAddress;
...
unsigned int WINAPI IOCP_OuterServer::WorkServer(LPVOID selfInstanceAddress)
{
	IOCP_OuterServer* thisInstanceAddress;
...
unsigned int IOCP_OuterServer::AcceptClient()
{
...
unsigned int IOCP_OuterServer::DisconnectClient()
{
...
unsigned int IOCP_OuterServer::WorkServer()
{
	DWORD transferredSize;
	ULONG_PTR completionKey;
	LPOVERLAPPED overlapped;
