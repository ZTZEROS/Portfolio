...
LoginLAN_Server::LoginLAN_Server()
{
...
bool LoginLAN_Server::Initialize()
{
	{
		CurrentClientCount = 0;
		EnqueuedWorkCount = 0;
...
bool LoginLAN_Server::Render()
{
	//if (TIMER.ShowCounter()) //CheckRender()
	{
		printf(
			"===== LoginLAN_Server ======" CRALF
...
bool LoginLAN_Server::Terminalize()
{
	{
