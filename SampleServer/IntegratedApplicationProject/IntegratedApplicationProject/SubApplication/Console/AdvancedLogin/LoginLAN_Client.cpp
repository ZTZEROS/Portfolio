...
AdvancedLoginClientServer LoginLAN_Client::ALCS;

LoginLAN_Client::LoginLAN_Client()
{
...
bool LoginLAN_Client::Initialize()
{
	{
		CurrentClientCount = 0;
		ConnectedClientCount = 0;
...

	{
		...
		_wfopen_s(&jsonFile, L"LoginLAN.ini", L"r, ccs=UTF-16LE");
...
bool LoginLAN_Client::Render()
{
	//if (TIMER.ShowCounter()) //CheckRender()
	{
		printf(
			"===== LoginLAN_Client ======" CRALF
...
bool LoginLAN_Client::Terminalize()
{
	{
