...
AdvancedChatClientPlayerAddressL ChatLAN_Server::ACCPAL;
SRWLOCK ChatLAN_Server::ACCPAL_LOCK;

ThreadLocalPool<AdvancedChatClientPlayer> ChatLAN_Server::ACCP_TLP;
ThreadLocalPool<AdvancedChatWork> ChatLAN_Server::ACW_TLP;

ChatLAN_Server::ChatLAN_Server()
{
	...
	InitializeSRWLock(&ACCPAL_LOCK);
}

ChatLAN_Server::~ChatLAN_Server() {}

bool ChatLAN_Server::Initialize()
{
	{
		CurrentClientCount = 0;
		ConnectedClientCount = 0;
...
bool ChatLAN_Server::Terminalize()
{
	{
