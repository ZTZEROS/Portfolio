...
extern FM_ServerSession FM_SERVER_SESSION;

extern FM_ClientSessionM FM_CLIENT_SESSION_M;

extern FM_MemberNameM FM_MEMBER_NAME_M;
extern FM_MemberNumberLM FM_OFFEREE_MEMBER_NUMBER_LM;
extern FM_MemberNumberLM FM_OFFERER_MEMBER_NUMBER_LM;
extern FM_MemberNumberLM FM_FRIEND_MEMBER_NUMBER_LM;

extern TIMEVAL FM_SERVER_TIME_VALUE;

extern unsigned int LAST_FM_CLIENT_INDEX;
extern unsigned int CURRENT_FM_CLIENT_COUNT;

extern unsigned int LAST_FM_MEMBER_INDEX;
extern unsigned int CURRENT_FM_MEMBER_COUNT;
extern unsigned int FM_MEMBER_NUMBER_A[TOTAL_FM_CLIENT_COUNT];
