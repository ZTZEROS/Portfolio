...
class IOCP_InnerServer
{
	//friend class IOCP_OuterServer;

private:
	IOCP_ServerSession SS; //ServerSession
	IOCP_ClientSessionV CSV; //ClientSessionV
	...
	IOCP_InnerServer* SelfInstanceAddress;
